...
Per creare un annuncio carosello con più schede invece di un singolo annuncio immagine o video, consulta [Creare un&#39;esperienza annuncio carosello Meta](/help/user-guide/create/create-meta-carousel-ad.md).
