...
+ Assistenti AI {#ai-assistants}
  + [Panoramica degli assistenti AI](ai-assistants/overview.md)
  + [Connetti un assistente AI](ai-assistants/connect-ai-assistants.md)
  + [Utilizza assistenti IA](ai-assistants/use-ai-assistants.md)
  + [Riferimento strumenti assistente IA](ai-assistants/tools-reference.md)
...
+ Crea {#create}
  ...
  + [Generare e perfezionare i contenuti con lo stato di generazione](create/stateful-generation.md)
  + [Traduci e localizza esperienze](create/translate-experiences.md)
  + [Modifica collaborativa](create/collaborative-editing.md)
  + [Usa scambio logo](create/logo-swap.md)
...
+ Modelli {#templates}
  + [Utilizzare i modelli](templates/use-templates.md)
...
+ Attiva {#activation}
  ...
  + Annunci multimediali a pagamento {#paid-media-ads}
    ...
    + [Il Trade Desk](activation/activate-trade-desk-ad.md)
+ Approfondimenti {#insights}
  + [Panoramica sugli approfondimenti](insights/overview.md)
  + [Filtri approfondimenti](insights/filter-views.md)
  + [Campagne](insights/campaigns.md)
  + [Dettagli esperienze pubblicate](insights/published-experiences.md)
  + [File multimediali](insights/media.md)
  + [Tag annuncio](insights/ad-tags.md)
  + Attributi {#attributes}
    + [Informazioni sugli attributi](insights/attributes.md)
...
+ {hide-from-toc}[GenStudio Academy - Nascosto](genstudioacademy.md)
+ {hide-from-toc}[Markdown di test - Nascosto](test-markdown.md)
