...
| Angolo videocamera | La prospettiva da cui la fotocamera cattura il soggetto, che influenza la percezione e l&#39;interpretazione dell&#39;immagine da parte dello spettatore. Se lo stile dell&#39;immagine è `photograph`, questa caratteristica viene identificata. | `Low angle`, `High angle`, `Eye level`, `Neutral angle`, `Bird's eye view`<p>Esempio di `eye level`:<p>![livello degli occhi](/help/assets/category/image-camera-angle.png "Persone sedute da angoli diversi"){width="200" zoomable="yes"} |
